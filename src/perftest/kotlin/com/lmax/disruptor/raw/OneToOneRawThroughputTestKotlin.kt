 ...
 */
class OneToOneRawThroughputTestKotlin : AbstractPerfTestDisruptor() {
    ...
    override fun runDisruptorPass(): PerfTestContext {
        ...
        val expectedCount = myRunnable.sequence.get() + ITERATIONS
        ...
        latch.await()
        perfTestContext.disruptorOps = ITERATIONS * 1000L / (System.currentTimeMillis() - start)
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val test = OneToOneRawThroughputTestKotlin()
